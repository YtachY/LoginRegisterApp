 ...
 * Date: 19/04/2022
 * Time: 11:50 PM
 * Path: app/src/main/java/vn/nhom5/lab04/ui/register
 *********************/
...
public class SQLiteConnector extends SQLiteOpenHelper {
     ...
     * @return list
     */
    public List<LoggedInUser> getAllUser() {
        ...
        List<LoggedInUser> userList = new ArrayList<LoggedInUser>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.setUserEmail(cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_USER_EMAIL)));
     ...
     * @param user
     */
    public void deleteUser(LoggedInUser user) {
        SQLiteDatabase db = this.getWritableDatabase();
